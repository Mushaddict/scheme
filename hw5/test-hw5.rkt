...
(eval-term*?
  ...
  'E0
  ; Input term
  '[(define x 1) ((closure E3 (lambda (z)   (define x 2) (define y 20) x)) 3)]
  ; Output value
  2
  ; Output memory
  '((E0 (x . 1)) (E1 E0) (E2 E1) (E3 E2) (E4 E3 (x . 2) (y . 20) (z . 3))))
...
(eval-term*?
  ...
  'E0
  ; Input term
  '[(define x 1) ((closure E3 (lambda (z)   (define x 2) (define y 20) (define x 9) x)) 3)]
  ; Output value
  9
  ; Output memory
  '((E0 (x . 1)) (E1 E0) (E2 E1) (E3 E2) (E4 E3 (x . 9) (y . 20) (z . 3))))
